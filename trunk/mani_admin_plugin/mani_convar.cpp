...
ConVar mani_command_flood_punish ("mani_command_flood_punish", "0", 0, "Punish players for chat spamming. 0 = Disabled, 1 = Kick player");
ConVar mani_command_flood_violation_count ("mani_command_flood_violation_count", "15", 0, "Number of times a player recieves the spam warning before being punished");
ConVar mani_command_flood_punish_ban_time ("mani_command_flood_punish_ban_time", "5", 0, "Time in seconds to ban for after chat spamming");
